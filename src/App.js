...
function App() {
    ...
    if (geo) {
      ...
      return geo.map((item, index) => {
        ...
        if (coordinate) {
          ...
          polygonRefs.current[item.name] = ref;
          return (
            <Polygon
              key={item.name}
              ...
              ref={ref}
              eventHandlers={{
                click: () => handlePolygonClick(item.name)
              }}
            />
          );
        }
  ...
  return (
    <div className="App">
      ...
      <button onClick={() => handlePolygonClick("leo")}>
        Rumah Leo
      </button>
      <button onClick={() => handlePolygonClick("hery")}>
        Kost Hery
      </button>
      <button onClick={() => handlePolygonClick("rizky")}>
        Rumah Rizky
      </button>
